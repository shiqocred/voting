<div class="bg-slate-400 min-h-screen flex flex-col items-center justify-center bg-[url('../img/hero-60.png')]">
    ...
    <div class="w-screen flex flex-col xl:flex-wrap xl:flex-row items-center justify-center pt-[130px] pb-10">
      <div class="w-full md:w-4/12 md:m-5 my-2  flex justify-center">
        <div class="w-11/12 bg-slate-100 flex justify-between px-10  py-3 rounded-md">
          <h4 class="text-xl font-bold">Total Posisi</h4>
          <span>{{ $totalPositions }}</span>
        </div>
      </div>
      <div class="w-full md:w-4/12 md:m-5 my-2 flex justify-center">
        <div class="w-11/12 bg-slate-100 flex justify-between px-10  py-3 rounded-md">
          <h4 class="text-xl font-bold">Total Pemilih</h4>
      ...
      <div class="w-full md:w-4/12 md:m-5 my-2 flex justify-center">
        <div class="w-11/12 bg-slate-100 flex justify-between px-10  py-3 rounded-md">
          <h4 class="text-xl font-bold">Total Suara</h4>
