<div>
    ...
    <div class="w-screen xl:py-32 lg:py-24 lg:px-32 py-20 px-8 xl:px-40 bg-[url('../img/hero.png')] bg-slate-400 h-screen relative">
      @if ($showDetails == true)
              ...
              <div class="w-full px-5 py-5 sm:py-10 bg-slate-100 flex sm:flex-row flex-col justify-center items-center">
                  ...
                  <div class="w-full sm:w-3/6 flex">
                      <div class="w-full flex flex-col items-start space-y-3 text-slate-700">
                          ...
                          <div class="w-full">
                              <h3>Visi:</h3>
                              <span class="w-full rounded-md block py-2 px-5 bg-slate-300 ">{{ $detail_visi }}</span>
                          </div>
                          <div class="w-full">
                              <h3>Misi:</h3>
                              <span class="w-full rounded-md block py-2 px-5 bg-slate-300 ">{{ $detail_misi }}</span>
                          </div>
                      </div>
                  </div>
              </div>
      ...
      <div class="text-sm px-3 py-2 lg:px-10 rounded-md mb-5 lg:mb-5 bg-red-400/60 backdrop-blur-md text-white flex">
