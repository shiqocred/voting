<div>
    ...
    <div class="w-screen h-screen bg-[url('../img/hero.png')] bg-slate-400 flex justify-center items-center pt-14">
        <div class="lg:w-5/12 lg:h-[80%] hidden bg-slate-200 rounded-l-lg lg:flex flex-col justify-center items-center relative">
            @if ($time_to_start <= $date_now)
        ...
        <div class="lg:w-3/12 lg:h-[80%] md:w-8/12 h-[500px] w-11/12 bg-slate-600/60 backdrop-blur-md rounded-r-lg">
