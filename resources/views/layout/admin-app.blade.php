...
<body>
    <div class="w-screen navWeb h-14 flex md:px-20 justify-between z-20 px-5 items-center text-xl fixed top-0 bg-slate-200/30 backdrop-blur-md">
        ...
        <div class="absolute left-0 px-5 top-14 h-10 items-center backdrop-blur-md bg-slate-600/50 lg:bg-transparent lg:relative lg:top-0 lg:w-auto lg:h-full snap-x scroll-smooth lg:backdrop-blur-0 w-screen sm:justify-center overflow-scroll flex space-x-5">
